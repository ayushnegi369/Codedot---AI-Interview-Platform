...
export default function SignUp() {
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-black to-[#18181b] overflow-hidden">
      ...
      >
        ...
        >
          <defs>
            ...
            >
              {/* Fill a few blocks with gray shade for visual interest */}
              ...
              {/* You can add more gray blocks in a pattern for a more dynamic look */}
              <path
      ...
      <div className="relative w-full max-w-md bg-[#18181b] rounded-2xl shadow-xl p-8 md:p-10 border border-gray-700/50 z-10 mx-4 sm:mx-6 md:mx-0 my-4 md:my-8">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-lg text-gray-300 text-center">Practice job interviews with AI</p>
        </div>
        <form className="flex flex-col gap-4">
          ...
          <div>
            ...
            <input
              type="email"
              placeholder="ayushnegi@example.com"
              className="w-full rounded-lg bg-[#23232a] text-white px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 font-semibold placeholder:font-normal placeholder:text-gray-400"
            />
          </div>
          <div>
          ...
          <div>
            ...
            <label className="w-full flex items-center gap-2 rounded-lg bg-[#23232a] px-4 py-2 cursor-pointer text-gray-400 hover:bg-[#23232a]/80">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 16v-8m0 0l-3 3m3-3l3 3M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
              <span>Upload an image</span>
              <input type="file" accept="image/*" className="hidden" />
            </label>
          </div>
          <div>
            <label className="block text-sm text-gray-300 mb-1">Resume</label>
            <label className="w-full flex items-center gap-2 rounded-lg bg-[#23232a] px-4 py-2 cursor-pointer text-gray-400 hover:bg-[#23232a]/80">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 16v-8m0 0l-3 3m3-3l3 3M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
        ...
        <div className="mt-6 text-center text-gray-400 text-sm">
          ...
          <a href="/login" className="text-[#b7aaff] hover:underline font-semibold">Log in</a>
        </div>
      </div>
    </div>
  );
